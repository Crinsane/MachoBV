...
import nl.machobv.models.RouteDataOnDemand;
...
privileged aspect RouteDataOnDemand_Roo_DataOnDemand {
    ...
    @Autowired
    CityDataOnDemand RouteDataOnDemand.cityDataOnDemand;
    ...
    public void RouteDataOnDemand.setDistance(Route obj, int index) {
        double distance = new Integer(index).doubleValue();
        obj.setDistance(distance);
    }
    
    public void RouteDataOnDemand.setDuration(Route obj, int index) {
