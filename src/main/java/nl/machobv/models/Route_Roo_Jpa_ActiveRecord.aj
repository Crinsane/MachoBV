...
privileged aspect Route_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> Route.fieldNames4OrderClauseFilter = java.util.Arrays.asList("origin", "destination", "distance", "duration");
    ...
    public static List<Route> Route.findAllRoutes(String sortFieldName, String sortOrder) {
        String jpaQuery = "SELECT o FROM Route o";
        ...
        return entityManager().createQuery(jpaQuery, Route.class).getResultList();
    }
    ...
    public static List<Route> Route.findRouteEntries(int firstResult, int maxResults, String sortFieldName, String sortOrder) {
        String jpaQuery = "SELECT o FROM Route o";
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            jpaQuery = jpaQuery + " ORDER BY " + sortFieldName;
            if ("ASC".equalsIgnoreCase(sortOrder) || "DESC".equalsIgnoreCase(sortOrder)) {
        ...
        return entityManager().createQuery(jpaQuery, Route.class).setFirstResult(firstResult).setMaxResults(maxResults).getResultList();
    }
